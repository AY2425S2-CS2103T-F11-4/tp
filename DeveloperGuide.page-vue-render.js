...
with(this){return _c('p',[_v("The proposed undo/redo mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedLoanBook")]),_v(". It extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LoanBook")]),_v(" with an undo/redo history, stored internally as an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("loanBookStateList")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(". Additionally, it implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedLoanBook#commit()")]),_v(" — Saves the current loan book state in its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedLoanBook#undo()")]),_v(" — Restores the previous loan book state from its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedLoanBook#redo()")]),_v(" — Restores a previously undone loan book state from its history.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitLoanBook()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoLoanBook()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoLoanBook()")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application for the first time. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedLoanBook")]),_v(" will be initialized with the initial loan book state, and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" pointing to that single loan book state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command to delete the 5th loan in the loan book. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitLoanBook()")]),_v(", causing the modified state of the loan book after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command executes to be saved in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("loanBookStateList")]),_v(", and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is shifted to the newly inserted loan book state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" to add a new loan. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command also calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitLoanBook()")]),_v(", causing another modified loan book state to be saved into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("loanBookStateList")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user now decides that adding the loan was a mistake, and decides to undo that action by executing the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoLoanBook()")]),_v(", which will shift the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" once to the left, pointing it to the previous loan book state, and restores the loan book to that state.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Saves the entire loan book.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Individual command knows how to undo/redo by\nitself.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the loan being deleted).")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual command are correct.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new loan with borrower's name.")])]),_v(" "),_c('li',[_c('p',[_v("System records the new loan in the loan list.")])]),_v(" "),_c('li',[_c('p',[_v("System confirms that the loan has been successfully added.\nUse case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("1a. The loan does not exist in the system.\n"),_c('ul',[_c('li',[_v("1a.1. System displays a message indicating that the loan is not found.")]),_v(" "),_c('li',[_v("Use Case Ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("List")]),_v(" Current Loans")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Prerequisites: The first entry on the currently displayed list has a loan amount of $100.00.")])]),_v(" "),_c('li',[_c('p',[_v("Adding loan repayments to entries")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("repay 1 l/60.00 d/3rd Jan 2025")]),_v("\nExpected: The first entry on the list now has a loan amount of $40.00. The repayment transaction details are added to the transaction history.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("repay 1 l/50.00 d/4th Jan 2025")]),_v("\nExpected: No transaction is created. Error details shown in the status message. Command is not erased from input field.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("repay 1 l/40.00 d/4th Jan 2025")]),_v("\nExpected: The first entry on the list now has a loan amount of $0.00 and shows \"Not Wanted\". The repayment transaction details are added to the transaction history.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"displaying-all-entries"}},[_v("Displaying all entries"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#displaying-all-entries","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v("\nExpected: All entries are displayed. (No change occurs)")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Prerequisites: There are multiple entries on the list with different loan amounts.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v("\nExpected: All entries are sorted in decreasing order of loan amount.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Display most recent loan transaction at the top of transaction history")]),_v(": The current transaction history displays\nloan transactions from oldest to newest. We intend to change the display from newest transaction recorded to oldest recorded transaction.")]),_v(" "),_c('li',[_c('strong',[_v("Enforce stricter date parsing")]),_v(": Current string parsing requires three string inputs separated by spaces.\nWe will enhance this by parsing dates as DateTime objects to enforce a consistent format and improve reliability.")]),_v(" "),_c('li',[_c('strong',[_v("Display total amount loaned to a borrower")]),_v(": The LoanCard currently displays only the total amount owed by a borrower.\nWe will enhance it to also display the total amount borrowed overall for better financial tracking.")]),_v(" "),_c('li',[_c('strong',[_v("Update find display")]),_v(": The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command displays output at the top of the Wanted list.\nWe will enhance the display to filter out loan entries with borrowers whose names match none of the find query terms.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 19:18:21 GMT+8]")])])])}
}];
